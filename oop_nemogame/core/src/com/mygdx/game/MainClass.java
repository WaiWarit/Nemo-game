...
public class MainClass extends ApplicationAdapter {
	...
	Texture img, img2, img3, img4, img5; //รูป
	...
	public void create () {
		...
		//set รูปภาพ
		img = new Texture(Gdx.files.internal("boat.png"));
		img2 = new Texture(Gdx.files.internal("fish1.png"));
		img3 = new Texture(Gdx.files.internal("fish2.png"));
		img4 = new Texture(Gdx.files.internal("fish3.png"));
		
		img5 = new Texture(Gdx.files.internal("2.png"));
	...
	public void render () {
		...
		x5 -= 300 * Gdx.graphics.getDeltaTime();
		//ทำให้รูปภาพขยับ
...
//		
		...
		if (Gdx.input.isKeyPressed(Keys.SPACE)) {
			float x5 = x1;
			batch.draw(img5, x5, y5, 10, 10);//ตัวสาม
		}
